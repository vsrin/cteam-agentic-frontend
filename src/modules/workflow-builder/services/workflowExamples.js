...
const emailProcessingWorkflow = {
      ...
      },
      {
        ...
        data: {
          ...
          properties: {
            ...
            temperature: 0.7,
            maxTokens: 1000,
            systemPrompt: 'Generate a helpful, professional email response based on the template and customer email.'
          }
        }
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          properties: {
            ...
            temperature: 0.2,
            maxTokens: 300,
            systemPrompt: 'Analyze the customer query to determine their intent and needed information.'
          }
        }
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          properties: {
            ...
            temperature: 0.7,
            maxTokens: 1000,
            systemPrompt: 'You are a helpful customer support agent. Use the knowledge base information to answer customer queries accurately.'
          }
        }
      },
      {
  ...
  const dataAnalysisWorkflow = {
      ...
      },
      {
        ...
        data: {
          ...
          properties: {
            ...
            temperature: 0.2,
            maxTokens: 1500,
            systemPrompt: 'Analyze the preprocessed data to identify key trends, anomalies, and insights.'
          }
        }
      },
      {
    ...
    edges: [
      ...
      { id: 'e3-4', source: 'aiAgent-1', target: 'output-1', animated: true }
    ]
  };
  ...
  const contentGenerationWorkflow = {
      ...
      },
      {
        ...
        data: {
          ...
          properties: {
            ...
            temperature: 0.6,
            maxTokens: 2000,
            systemPrompt: 'Research the provided topic thoroughly. Gather key information, statistics, trends, and expert opinions.'
          }
        }
      },
      {
        ...
        data: {
          ...
          properties: {
            ...
            temperature: 0.7,
            maxTokens: 3000,
            systemPrompt: 'You are a skilled blog writer. Create an engaging, well-structured blog post using the research provided.'
          }
        }
      },
      {
    ...
    edges: [
      { id: 'e1-2', source: 'trigger-1', target: 'aiAgent-1', animated: true },
      { id: 'e2-3', source: 'aiAgent-1', target: 'aiAgent-2', animated: true },
      { id: 'e3-4', source: 'aiAgent-2', target: 'output-1', animated: true }
    ]
  };
