...
export default function ChatInterface({ agentConfig }) {
  ...
  const threadId = 1; // You might want to make this dynamic or pass it as a prop
  ...
  }, [isTyping, fullText, agentConfig]); // Fixed: Added agentConfig to dependencies
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setIsTyping(true);
      setFullText("Hello! I'm your AI assistant. How can I help you today?");
    }, 20);
  }, [agentConfig]); // Fixed: Added agentConfig to dependency array
  ...
  return (
    <>
      <div className="chat-container">
        ...
        /* Ensure all text elements in user messages are white */
        .message.user * {
